...
var coseLayout = function coseLayout(options, spectralResult) {
  ...
  var processConstraints = function processConstraints(layout, options) {
    // Ensure layout.constraints is initialized.
...
var Layout = function () {
  ...
  _createClass(Layout, [{
    ...
    value: function run() {
      ...
      // Ensure the layout options are consistent:
      if(options.quality === "draft" && !options.randomize) {
          console.warn("Randomize false with 'draft' quality is contradictory. Overriding quality to 'default'.");
